%% Optimal Model Predictive IBVS demo in matlab, SnakeRaven Cascade Method
...
title('3D View of Camera Trajectory for VPC-IBVS')
xlabel('X [mm]')
ylabel('Y [mm]')
zlabel('Z [mm]')
axis equal
...
title('VPC-IBVS Feature Motion on Image Plane')
xlabel('x - pixels')
ylabel('y - pixels')
...
title('Error over Time for VPC-IBVS')
xlabel('Time [s]')
ylabel('Error [Pixels]')
